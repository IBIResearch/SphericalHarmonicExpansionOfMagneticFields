"""
    ffp = findFFP(expansion::Array{Polynomial}, x::Variable, y::Variable, z::Variable; returnasmatrix::Bool=true)
...
"""
function findFFP(expansion::Array{Polynomial}, x::Variable, y::Variable, z::Variable; returnasmatrix::Bool=true)
